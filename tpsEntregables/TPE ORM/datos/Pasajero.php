...
class Pasajero extends Persona
{
	...
	public function modificar(){
	    ...
	    $base=new BaseDatos();
	    if(parent::modificar()){
	        $consultaModifica="UPDATE pasajero SET numasiento=".$this->getNumAsiento()."numticket = ". $this->getNumTicket(). "idviaje=".$this->getObjViaje()->getCodigo()." WHERE pdocumento=". $this->getNrodoc(); 
	        if($base->Iniciar()){
